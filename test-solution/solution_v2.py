...
def postprocess_patches(image_file_name, original_image, predictions, coordinates, threshold=0.6, iou_threshold=0.5):
    all_predictions = []
    results = []
...
def create_solution_submission(folder_path, output_csv='solution_submission2.csv'):
    results_data = []
...
if __name__ == '__main__':
    create_solution_submission(r'images')

    with open("solution_submission2.csv", "r") as csvfile:
